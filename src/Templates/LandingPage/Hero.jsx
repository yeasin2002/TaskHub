        ...
        <div className="md:flex-row container flex flex-col items-center px-5 py-24 mx-auto">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left md:mb-0 flex flex-col items-center mb-16 text-center">
            ...
            <div className="flex justify-center">
              <button className="focus:outline-none hover:bg-indigo-600 inline-flex px-6 py-2 text-lg text-white bg-indigo-500 border-0 rounded">
                Button
              </button>
              <button className="focus:outline-none hover:bg-gray-200 inline-flex px-6 py-2 ml-4 text-lg text-gray-700 bg-gray-100 border-0 rounded">
                Button
              </button>
            </div>
